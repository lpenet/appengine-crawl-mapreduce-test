...
/* Slightly modified from Google Appengine sharded counter v2 example 
    
    See https://github.com/GoogleCloudPlatform/appengine-sharded-counters-java/blob/master/src/com/google/appengine/demos/shardedcounter/java/v2/ShardedCounter.java
*/
package fr.penet.utils;
